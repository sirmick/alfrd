  ...
  return (
    <IonPage>
      ...
      <IonContent className="ion-padding">
        ...
        {/* Tags */}
        {((document.tags && document.tags.length > 0) || (document.secondary_tags && document.secondary_tags.length > 0)) && (
          <IonCard>
            <IonCardHeader>
              <IonCardTitle>Tags</IonCardTitle>
            </IonCardHeader>
            <IonCardContent>
              {/* Primary tags (user-defined) */}
              {document.tags && document.tags.length > 0 && (
                <div style={{ marginBottom: '12px' }}>
                  <h3 style={{ fontSize: '0.9em', color: 'var(--ion-color-medium)', marginBottom: '8px' }}>User Tags</h3>
                  {document.tags.map((tag, idx) => (
                    <IonBadge key={idx} color="tertiary" style={{ marginRight: '8px', marginBottom: '8px' }}>
                      {tag}
                    </IonBadge>
                  ))}
                </div>
              ...
              {/* Secondary tags (auto-generated by classifier) */}
              {document.secondary_tags && document.secondary_tags.length > 0 && (
                <div>
                  <h3 style={{ fontSize: '0.9em', color: 'var(--ion-color-medium)', marginBottom: '8px' }}>Auto-Generated Tags</h3>
                  {document.secondary_tags.map((tag, idx) => (
                    <IonBadge key={idx} color="primary" style={{ marginRight: '8px', marginBottom: '8px' }}>
                      {tag}
                    </IonBadge>
                  ))}
                </div>
